    ...
    return (
      <div className="max-w-full bg-">
        <h1 className="text-6xl font-bold text-red-500 ">
          Welcome to TradeInclusive in {' '}
          <a className="link link-primary link-hover text-green-500" href="https://coreum.com/">
            Coreum!
          </a>
        </h1>
        ...
        <div className="flex flex-wrap items-center justify-around md:max-w-4xl mt-6 sm:w-full text-green-500">
          <button
